...
\begin{itemize}
    ...
    \item $f(x) = 313.1 x - 612397.6$, thus $f(2022) \approx 20691$;
    \item \textbf{Note: } We have to consider {\em significant figures} (SF) and {\em decimal point} (DP) when writing the report. 
    The results should keep the least SP. Any parameter we use to compute the result need to keep one additional DP.
\end{itemize}
